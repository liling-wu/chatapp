export interface Message {
  ...
  export const predefinedMessages: Message[] = [
    {
      id: '1',
      content: "Malfunction in Sauce Station Nr.1001 detected.\nInsufficient system knowledge available due to recent implementation. Expert input is required to address this issue. Please follow the questions and provide relevant information needed.\nFirst, describe Sauce Station Nr.1001 and its primary function.",
      role: 'assistant',
      timestamp: new Date(),
    },
    {
      id: '2',
      content: "Sauce Station Nr.1001 is an automated sauce dispenser on the Margherita line. It's set up to evenly spread tomato sauce over each pizza base as it moves down the line.",
      role: 'user',
      timestamp: new Date(),
    },
    {
    ...
    {
      id: '5',
      content: "What are the environmental conditions in which the Sauce Station operates?",
      role: 'assistant',
      timestamp: new Date(),
    },
    {
    ...
    {
      id: '7',
      content: "Have any changes been made to Sauce Station's configuration or operating environment?",
      role: 'assistant',
      timestamp: new Date(),
    },
    {
    ...
    {
      id: '12',
      content: "As each pizza base arrives, Sauce Station detects its position and starts dispensing from the center, moving out in a spiral motion. The sensor adjusts for the dough's position to make sure the sauce is applied evenly, then shuts off once the portion is complete.",
      role: 'user',
      timestamp: new Date(),
    },
    {
